...
import 'package:valfinder/utils/animations.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:TextFormField(
              style: const TextStyle(color: Colors.white),
              decoration:const  InputDecoration(
                suffixIcon: Icon(Icons.dew_point,color: Colors.white,),
               fillColor: Colors.white,
                border: InputBorder.none,),
            ),
          ),
          ...
          Container(
            ...
            child:TextFormField(
              style: const TextStyle(color: Colors.white),
              decoration:const  InputDecoration(
                suffixIcon: Icon(Icons.calendar_view_day,color: Colors.white,),
                fillColor: Colors.white,
                border: InputBorder.none,),
            ),
          ),
       ...
       const   Spacer(),
           GestureDetector(
              ...
              child: const Text('Already a User?Login Now',style: TextStyle(fontSize: 12,fontWeight:FontWeight.w600,color: Colors.white),)),
          const   Spacer(),
